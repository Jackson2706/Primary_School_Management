# Generated by Django 4.1.5 on 2023-01-13 01:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('course_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='student_management_app.class')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_id', models.ManyToManyField(to='student_management_app.class')),
        ...
        migrations.AddField(
            model_name='class',
            name='school_year_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.schoolyearmodel'),
        ),
        migrations.AddField(
            model_name='class',
        ...
        migrations.AddField(
            model_name='class',
            name='staff_id',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.staffs'),
        ),
        migrations.CreateModel(
